...
function Header() {
    //On utilise activeMenuItem pour suivre l'element actif
    const [activeMenuItem, setActiveMenuItem] = useState('');
    //L25/26 : Lorsqu'un élément du menu est cliqué, nous appelons la fonction menuItemClick pour mettre à jour l'état avec la valeur qui correspond à l'élément cliqué.
    ...
    <div className='header'>
        <svg id="logo-kasa-banner" width="211" height="68" viewBox="0 0 211 68" fill="none" xmlns="http://www.w3.org/2000/svg">
